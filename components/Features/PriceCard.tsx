...
const PriceCard = ({ price, name, highlight, description, features }: Plan) => {
  ...
  return highlight ? (
    ...
    <div className="shadow-lg rounded-lg bg-white flex flex-col items-center justify-content-center p-8 aspect-[9/16]">
      ...
      <Button
        onClick={redirectToApp}
        className="py-2 px-4 my-2 bg-blue-500 hover:bg-blue-700 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md rounded-lg "
      >
